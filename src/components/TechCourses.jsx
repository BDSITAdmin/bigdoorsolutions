      ...
      <div className="container mx-auto">
        <div className="flex justify-between items-center flex-wrap space-x-4">
          ...
          <p className="text-Azure md:w-[50%]">
            All our tech courses are designed by industry experts to provide hands-on experience...
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-8">
          {courses.map((course) => (
            <div key={course.id} className="bg-white overflow-hidden">
              <img src={course.image} alt={`Image of ${course.title}`} className="w-full h-48 object-cover" />
              <div className="pt-6">
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-gray-500 text-sm flex items-center">
                    <img src={course.image1} alt="Clock icon" className="" />
                    {course.duration}
                  </div>
                </div>

                <h3 className="mt-4 font-sora text-[20px] font-semibold leading-[22px] text-[#1D2026]">
                  {course.title}
                </h3>
                ...
                <button
                  className="flex items-center justify-center mt-4 w-full bg-white border-[1px] border-[#2E89E5] text-[#2E89E5] font-semibold py-2 px-4 rounded-lg hover:bg-blue-500 hover:text-white transition duration-200"
